...
(when (modulep! :editor lispye)
  (after! lispy
    ;; navigation
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "l") 'special-lispy-right)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "h") 'special-lispy-left)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "f") 'special-lispy-flow)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "j") 'special-lispy-down)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "k") 'special-lispy-up)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "d") 'special-lispy-different)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "o") 'special-lispy-other-mode)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "p") 'special-lispy-eval-other-window)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "P") 'special-lispy-paste)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "y") 'special-lispy-occur)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "z") 'special-lh-knight/body)
    ;; outline
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "J") 'special-lispy-outline-next)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "K") 'special-lispy-outline-prev)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "L") 'special-lispy-outline-goto-child)
    ;; Paredit transformations
    (lispy-define-key lispy-mode-map-special ">" 'special-lispy-slurp)
    (lispy-define-key lispy-mode-map-special "<" 'special-lispy-barf)
    (lispy-define-key lispy-mode-map-special "/" 'special-lispy-splice)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "r") 'special-lispy-raise)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "R") 'special-lispy-raise-some)
    (lispy-define-key lispy-mode-map-special "+" 'special-lispy-join)
    ;; more transformations
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "C") 'special-lispy-convolute)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "X") 'special-lispy-convolute-left)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "w") 'special-lispy-move-up)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "s") 'special-lispy-move-down)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "O") 'special-lispy-oneline)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "M") 'special-lispy-alt-multiline)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "S") 'special-lispy-stringify)
    ;; marking
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "a") 'special-lispy-ace-symbol
      :override '(cond ((looking-at lispy-outline)
                        (lispy-meta-return))))
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "H") 'special-lispy-ace-symbol-replace)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "m") 'special-lispy-mark-list)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "e") 'special-lispy-eval)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "E") 'special-lispy-eval-and-insert)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "g") 'special-lispy-goto-local)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "G") 'special-lispy-goto)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "F") 'special-lispy-follow)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "D") 'special-pop-tag-mark)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "A") 'special-lispy-beginning-of-defun)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "i") 'special-lispy-tab)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "I") 'special-lispy-shifttab)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "N") 'special-lispy-narrow)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "W") 'special-lispy-widen)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "c") 'special-lispy-clone)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "u") 'special-lispy-undo)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "q") 'special-lispy-ace-paren
      :override '(cond ((bound-and-true-p view-mode)
                        (View-quit))))
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "Q") 'special-lispy-ace-char)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "v") 'special-lispy-view)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "t") 'special-lispy-teleport
      :override '(cond ((looking-at lispy-outline)
                        (end-of-line))))
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "n") 'special-lispy-new-copy)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "b") 'special-lispy-back)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "B") 'special-lispy-ediff-regions)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "x") 'special-lispy-x)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "Z") 'special-lispy-edebug-stop)
    (lispy-define-key lispy-mode-map-special (cae-keyboard-kbd "V") 'special-lispy-visit)
    ;; If any of the above keys get mapped to these, the keybinding will be lost!
    (lispy-define-key lispy-mode-map-special "-" 'special-lispy-ace-subword)
    (lispy-define-key lispy-mode-map-special "." 'special-lispy-repeat)
    (lispy-define-key lispy-mode-map-special "~" 'special-lispy-tilde)
    (lispy-define-key lispy-mode-map-special "_" 'special-lispy-underscore)
    (lispy-define-key lispy-mode-map-special "'" 'special-lispy-tick) ;`special-lispy-eval-other-window' lost
    (lispy-define-key lispy-mode-map-special "=" (lookup-key lispy-mode-map-special (cae-keyboard-kbd-reverse "'")))
