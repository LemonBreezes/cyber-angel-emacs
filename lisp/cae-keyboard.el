...
(when (modulep! :editor lispy)
  (after! lispy
    ...
    (let ((bindings
           `((,(cae-keyboard-kbd "l") special-lispy-right "Move")
             (,(cae-keyboard-kbd "h") special-lispy-left "Move")
             (,(cae-keyboard-kbd "f") special-lispy-flow "Move")
             (,(cae-keyboard-kbd "j") special-lispy-down "Move")
             (,(cae-keyboard-kbd "k") special-lispy-up "Move")
