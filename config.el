...
;;
;;  (dolist (path (thread-last (shell-command-to-string "/mnt/c/Windows/System32/cmd.exe /C \"echo %PATH%\"")
;;                             (string-replace "" "")
;;                             (string-replace "\n" "")
...
;;        (split-string
;;         (replace "\n\r"
;;                  (shell-command-to-string "/mnt/c/Windows/System32/cmd.exe /C \"echo %PATH%\""))
;;         ";")))
