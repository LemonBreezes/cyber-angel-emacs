...
(when cae-init-editor-enabled-p
    ...
    (setq avy-timeout-seconds 0.4
          ...
          (cae-keyboard-remap
           '((?z . avy-action-zap-to-char)
             ...
             (?r . cae-avy-parrot-rotate-forward-dispatch)
             (?R . cae-avy-parrot-rotate-backward-dispatch)
  ...
  (use-package! parrot-rotate
    ...
    (map! :n "]r" #'cae-modeline-rotate-forward-word-at-point
          :n "]R" #'cae-avy-rotate-forward
          :n "[r" #'cae-modeline-rotate-backward-word-at-point
          :n "[R" #'cae-avy-rotate-backward)
    :config
    (after! parrot-rotate
...
(when doom-incremental-first-idle-timer
