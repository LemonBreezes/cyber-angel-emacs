...
(when (modulep! :ui popup)
  ...
  (set-popup-rule! "^\\*info.*" :size 82 :side 'right :ttl t :select t :quit t :ttl t)
  (set-popup-rule! "^\\*Man.*" :size 82 :side 'right :ttl t :select t :quit t :ttl 0)
  (set-popup-rule! "^\\*tldr\\*" :size 82 :side 'right :select t :quit t)
  (set-popup-rule! "^\\*helpful.*" :size 82 :side 'right :select t :quit t :ttl 0)
  (set-popup-rule! "^\\*Help.*" :size 82 :height 0.6 :side 'right :select t :quit t :ttl 0)
  (set-popup-rule! "^ \\*Metahelp.*" :size 82 :side 'right :select t :quit t :ttl 0)
  (set-popup-rule! "^\\*Apropos.*" :size 82 :height 0.6 :side 'right :select t :quit t :ttl 0)
