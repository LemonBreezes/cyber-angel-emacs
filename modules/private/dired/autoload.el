...
(defhydra cae-dired-dirvish-hydra (:color pink)
  ...
  ("M-r" dirvish-rsync "Rsync menu" :column "Menus")
  ("M-c" dirvish-chxxx-menu "ChXXX menu" :column "Menus")
  ("M-h" dirvish-history-menu "History menu" :column "Menus")
  ("M-;" dirvish-epa-dired-menu "EPA menu" :column "Menus")
