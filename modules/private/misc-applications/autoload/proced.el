 ...
 `(defhydra +proced-hydra (:color pink :hint nil)
    ...
    ,@(if (modulep! :editor evil)
          '(("p" proced-mark-parents "Mark parents" :column "Mark")
            ("gr" revert-buffer "Refresh" :column "Display")
    ...
    ,@(if (modulep! :editor evil)
          '(("~" proced-toggle-marks "Toggle marks" :column "Mark")
            ...
            ("oO" proced-sort-interactive "Set sorting" :column "Sort")
            ("oc" proced-sort-pcpu "Sort by CPU usage" :column "Sort")
            ("om" proced-sort-pmem "Sort by memory usage" :column "Sort")
            ("op" proced-sort-pid "Sort by PID" :column "Sort")
            ("oo" proced-sort-start "Sort by start time" :column "Sort")
            ("ot" proced-sort-time "Sort by CPU time" :column "Sort")
            ("ou" proced-sort-user "Sort by user" :column "Sort"))
