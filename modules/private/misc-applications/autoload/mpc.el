...
(eval
 `(defhydra +mpc-hydra (:color pink :hint nil)
    ...
    (">" mpc-next "Next song")
    (,(if (modulep! :editor evil) "t" "s") mpc-toggle-play "Toggle play" "Toggle")
    ,@(when (modulep! :editor evil)
        '(("r" mpc-toggle-repeat "Toggle repeat" "Toggle")
          ("s" mpc-toggle-shuffle "Toggle shuffle" "Toggle")
          ("c" mpc-toggle-consume "Toggle consume" "Toggle")
