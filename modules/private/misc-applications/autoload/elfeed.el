...
(defhydra cae-elfeed-hydra (:color pink :foreign-keys run)
  ...
  ("RET" elfeed-search-show-entry "Show entry" :column "")
  ("b" elfeed-search-browse-url "Open entry" :column "")
  ("n" next-line "Next line" :column "")
  ("p" previous-line "Previous line" :column "")
  ("<" elfeed-search-first-entry "First entry" :column "")
  (">" elfeed-search-last-entry "Last entry" :column "")
  ("y" elfeed-search-yank "Yank" :column "")
