...
This is my Emacs OS. I use it for everything. Here is a summary of some of my modules
from most interesting to least interesting (in my opinion):
...
4. Configuration for a notification daemon implemented in Elisp, ~ednc~.
