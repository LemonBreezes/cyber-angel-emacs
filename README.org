...
1. ~use-comp-speed-3.patch~: Sets the default compilation speed to 3, which
   generates after code than the default of 2.
...
4. ~cae-doom-emacs.patch~: This patch is a patch I wrote for Doom Emacs which
   patches in some pending PRs to Doom Emacs. I use this patch to test out PRs.
