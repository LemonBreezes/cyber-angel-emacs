...
;;; Frozen versions
;; Generated by `M-x cae-packages-freeze' (see lisp/cae-package-freeze.el).
;; Loaded last so these `:pin's win over any module/package pins above.
;; NOTE: do NOT add `(unpin! t)` here — it stamps `:unpin t` on every package,
...
(load (file-name-concat doom-user-dir "cae-frozen-packages.el") t t)
