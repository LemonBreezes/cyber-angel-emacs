...
(let ((q t))
  ...
  (let ((c t))
    (defvar cae-init-core-enabled-p (and q c t))
    (defvar cae-init-tty-enabled-p (and q c t))
    (defvar cae-init-bindings-enabled-p (and q c t))
    (defvar cae-init-multi-enabled-p (and q c t))
    (defvar cae-init-smartparens-enabled-p (and q c t))
    (defvar cae-init-projectile-enabled-p (and q c t))
    (defvar cae-init-evil-enabled-p (and q c t))
    (defvar cae-init-exwm-enabled-p (and q c t)))
