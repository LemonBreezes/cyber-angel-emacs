...
(let ((q t))
  ...
  (defvar cae-init-tty-enabled-p (and q t))
  (defvar cae-init-bindings-enabled-p (and q t))
  (defvar cae-init-multi-enabled-p (and q t))
  (defvar cae-init-smartparens-enabled-p (and q t))
  (defvar cae-init-projectile-enabled-p (and q t))
