...
(defhydra embark-collect-cheatsheet-hydra (:color pink :foreign-keys run)
  ("<f6>" nil "Exit" :exit t)
  ("a" embark-act "Act")
  ("<" beginning-of-buffer "Navigation")
  (">" end-of-buffer "Navigation")
  ("A" embark-act-all "Act")
  ("E" embark-export "Act")
  ("M-<left>" tabulated-list-previous-column "Navigation")
  ("M-<right>" tabulated-list-next-column "Navigation")
  ("M-a" embark-collect-direct-action-minor-mode "Act")
  ("M-{" outline-previous-heading "Navigation")
  ("M-}" outline-next-heading "Navigation")
  ("S" tabulated-list-sort "Navigation")
  ("SPC" scroll-up-command "Navigation")
  ("S-SPC" scroll-down-command "Navigation")
  ("U" embark-collect-unmark-all "Act")
  ("g" revert-buffer "Act")
  ("m" embark-collect-mark "Act")
  ("s" isearch-forward "Navigation")
  ("t" embark-collect-toggle-marks "Act")
  ("u" embark-collect-unmark "Act")
  ("{" tabulated-list-narrow-current-column "Navigation")
  ("}" tabulated-list-widen-current-column "Navigation")
